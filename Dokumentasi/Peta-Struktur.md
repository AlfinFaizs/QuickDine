...
Dokumen ini berisi **peta struktur folder, pembagian domain arsitektur, dan alur data modular** pada repositori **QuickDine** per Agustus 2026 (pasca **Branch-0 Fondasi + Branch-1 Otentikasi + Branch-2 Pendaftaran Mitra + Branch-3 Alur Pemesanan Customer + Branch-4 Landing & Jelajah**).
...
│   ├── Kamus-File.md                         // [ENSIKLOPEDIA] Kamus detail 41+ file kode
...
│   │   │
│   │   └── tables/                           // Modul Manajemen Meja Resto
